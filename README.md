...
{
	Lcd_cursor(&lcd,0,1);
	Lcd_string(&lcd,"ANBU SELVAN S");
	Lcd_cursor(&lcd,1,1);
	Lcd_string(&lcd,"212223110003\n");
	for(int x=0;x<100;x++)
	{
		Lcd_cursor(&lcd,2,1);
		Lcd_int(&lcd,x);
...
1.OFF:
![image](https://github.com/user-attachments/assets/d186e0a8-403a-4c12-b5a0-8c1073c7b5a3)

2.ON:
![image](https://github.com/user-attachments/assets/703fed10-b00b-45e7-8032-f4daa6d2380d)


## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
![image](https://github.com/user-attachments/assets/9fa77268-17c6-4323-a7a1-0b9d62f29732)
